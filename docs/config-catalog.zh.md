...
来源：[`packages/web/web-search-duckduckgo/src/index.ts:39`](../packages/web/web-search-duckduckgo/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-theme-cyberpunk`（[`packages/client/ui-theme-cyberpunk/src/index.ts`](../packages/client/ui-theme-cyberpunk/src/index.ts)）
