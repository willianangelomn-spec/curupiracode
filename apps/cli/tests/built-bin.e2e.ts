...
describe.skipIf(!existsSync(dshBin))('dsh BUILT bin (node lib/bin.js, no tsx)', () => {
  it('requires --profile and rejects removed commands', async () => {
    ...
    expect(help.stdout).toContain('curupiracode --profile web')
  ...
  it('routes help and usage errors without activating startup-dependent rows', async () => {
    ...
    try {
      ...
      expect(web.stdout).toContain('Usage: curupiracode web')
      expect(web.stdout).toContain('--port <port>')
      expect(web.stdout).not.toContain('CurupiraCode web: http://')
      ...
      expect(wildcardHost.stderr).not.toContain('CurupiraCode web: http://')
      ...
      expect(headlessHelp.stdout).toContain('Usage: curupiracode --profile headless')
