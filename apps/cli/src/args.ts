...
const HELP_EXAMPLES = `
Examples:
  curupiracode --profile web                          boot the web profile (same as: curupiracode web)
  curupiracode --profile headless "run the tests"     answer one task, print the result, and exit
  curupiracode --profile tui --patch ./extra.yml      boot a custom profile with one extra overlay
  curupiracode --profile tui --resume <session>       arguments after the launcher flags reach the app
  curupiracode --profile web --help                   the web app's own flags and help
  curupiracode plugin --profile tui add <package>     install a plugin into the tui profile
`
...
export function parseDshArgs(argv: readonly string[], version: string): DshInvocation {
  ...
  program
    ...
    .description('CurupiraCode: IA aberta e local, composta por plugins sob seu controle.')
    ...
    .argument('[args...]', 'arguments for the booted profile\'s app (see: curupiracode --profile <name> --help)')
  ...
  web
    ...
    .passThroughOptions()
    .enablePositionalOptions()
    .argument('[args...]', 'arguments for the web app (see: curupiracode web --help)')
    .option('--patch <path>', 'extra patch-list overlay applied after the profile layer (repeatable)', collect)
