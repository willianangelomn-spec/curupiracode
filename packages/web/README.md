...
| [`web-search-duckduckgo/`](web-search-duckduckgo/README.md) | Provides keyless DuckDuckGo search with Bing fallback and Google News | registers on `ctx.web` |
| [`web-search-searxng/`](web-search-searxng/README.md) | Provides credential-free search through an operator-controlled SearXNG instance | registers on `ctx.web` |
