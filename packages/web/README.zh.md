...
| [`web-search-duckduckgo/`](web-search-duckduckgo/README.zh.md) | 提供无密钥 DuckDuckGo 搜索、Bing 回退与 Google News | 注册到 `ctx.web` |
| [`web-search-searxng/`](web-search-searxng/README.zh.md) | 通过运营者控制的 SearXNG 实例提供无需凭据的搜索 | 注册到 `ctx.web` |
