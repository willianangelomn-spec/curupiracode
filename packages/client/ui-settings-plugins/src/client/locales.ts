...
export const ptBR = {
  ...
  'bashMaxOutputBytesHint': 'A saída que exceder esse limite é despejada em um arquivo temporário em vez de ser perdida.',
  'agentLoopTitle': 'Agent loop',
  ...
  'agentLoopMaxParallelHint': 'Limite máximo de chamadas seguras para execução em paralelo ao mesmo tempo dentro de uma única etapa.',
  'webSearchTitle': 'Web search',
  ...
  'webSearchApiKeyUnset': 'Nenhuma chave está configurada; a busca ficará indisponível até que uma seja definida.',
  'webSearchBaseUrl': 'Endpoint',
  'webSearchBaseUrlHint': 'Deixe em branco para usar o endpoint padrão do provedor.',
