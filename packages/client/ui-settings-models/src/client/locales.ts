...
export const ptBR = {
  ...
  'deleteDescription': 'A exclusão de {provider} remove a configuração dele. Qualquer credencial usada por ele é gerenciada em outro lugar e será mantida.',
  'deleteDescriptionWithCredential': 'A exclusão de {provider} remove a configuração dele e a chave de API armazenada.',
  ...
  'keyBlank': 'Digite a chave de API ou deixe o campo vazio para manter a que está armazenada.',
  'keyBlankNew': 'Digite a chave de API ou deixe o campo vazio se este provedor usa outra forma de autenticação.',
  'keyIllegalCharacters': 'O formato desta chave de API não é válido. Verifique-a.',
  ...
  'modelMaxTokensInvalid': 'O máximo de tokens de saída deve ser uma quantidade positiva, como 8192, 64K ou 1M.',
  ...
  'fetchNeedsBaseUrl': 'Informe a base URL primeiro e, depois, faça a busca.',
  'fetchEmpty': 'O provedor não listou nenhum modelo. Adicione-os manualmente.',
  'fetchTitle': 'Escolher modelos para adicionar',
  'fetchDescription': 'Estes são os modelos que este provedor tem disponíveis. Escolha quais deseja adicionar.',
  ...
  'customRouteHint': 'Identificador em letras minúsculas, começando com uma letra, que identifica este provedor de forma exclusiva nas requisições e serve como nome da credencial dele.',
  'customRouteInvalid': 'Comece com uma letra minúscula; depois, use letras minúsculas, dígitos e hífens.',
  'customRouteTaken': 'Já existe um provedor usando este ID.',
  ...
  'onboardingDescription': 'Configure o provedor oficial da DeepSeek para começar a desenvolver.',
